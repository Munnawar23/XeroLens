          ...
          <View className="flex-1 justify-end items-center pb-12">
            ...
            >
              <View className="w-20 h-20 rounded-full bg-white/20 items-center justify-center border-4 border-white/60">
                <View className="w-16 h-16 rounded-full bg-[#FABD32] shadow-sm flex items-center justify-center">
                  <View className="w-12 h-12 rounded-full bg-white border-2 border-[#1E459F]" />
                </View>
              </View>
            </TouchableOpacity>
          </View>
      ...
      {isFlashing && (
        <View
          style={[
            ...
            { backgroundColor: "black", zIndex: 50 },
          ]}
          pointerEvents="none"
        />
      )}
